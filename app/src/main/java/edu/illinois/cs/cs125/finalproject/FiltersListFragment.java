...
import edu.illinois.cs.cs125.finalproject.utils.BitmapUtils;
import edu.illinois.cs.cs125.finalproject.utils.SpacesItemDecoration;
    ...
    public void prepareThumbnail(final Bitmap bitmap) {
        Runnable r = new Runnable() {
            public void run() {
                ...
                if (bitmap == null) {
                    thumbImage = BitmapUtils.getBitmapFromAssets(getActivity(), edu.illinois.cs.cs125.finalproject.MainActivity.IMAGE_NAME, 100, 100);
                } else {
